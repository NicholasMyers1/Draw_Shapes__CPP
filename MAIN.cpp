...
void display(){
	...
	//	glEnable(GL_LIGHTING);glEnable(GL_LIGHT0);
		...
		glClear(GL_COLOR_BUFFER_BIT|GL_DEPTH_BUFFER_BIT);glClearColor(1,1,1,0);//glLoadIdentity();
...
glViewport(0,0,w,h);gluPerspective(45.f,(GLfloat)w/(GLfloat)h,0.0f,1800.0f); 
